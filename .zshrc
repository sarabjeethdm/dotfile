...
[[ -f /home/linux-dex/.dart-cli-completion/zsh-config.zsh ]] && . /home/linux-dex/.dart-cli-completion/zsh-config.zsh || true
## [/Completion]
...
## application lunching with nvidia gpu
# brave() {
#   prime-run command brave &> /dev/null &
# }
# chromium() {
#   prime-run command chromium &> /dev/null &
# }
